...
public class SQLiteHelper extends SQLiteOpenHelper {
    ...
    private static String TABLE_NAME = "skins";
    ...
    public void remove_fav(int id){
        ...
        String sql = "UPDATE " + TABLE_NAME + " SET  " + "favorite ='0' WHERE " + KEY_ID + "=" + id + "";
        db.execSQL(sql);
    }

    public void add_fav(int id){
        SQLiteDatabase db = this.getWritableDatabase();
        String sql = "UPDATE " + TABLE_NAME + " SET  " + "favorite ='1' WHERE " + KEY_ID + "=" + id + "";
        db.execSQL(sql);
    }
}