...
public class FavsRecyclerViewAdapter extends RecyclerView.Adapter<FavsRecyclerViewAdapter.ViewHolder> {
    ...
    private FavsRecyclerViewAdapter.ItemClickListener mClickListener;

    public FavsRecyclerViewAdapter(Context context, ArrayList<Skin> images) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new FavsRecyclerViewAdapter.ViewHolder(view);
    }
    ...
    public void removeItem(int position){
        skinItems.remove(position);
        notifyItemRemoved(position);
        notifyItemRangeChanged(position, skinItems.size());
    }
    ...
    public void setClickListener(FavsRecyclerViewAdapter.ItemClickListener itemClickListener) {
